...
class TaskItemTest {
    ...
    public void TestCreateTaskItemFailsWithInvalidTitle() {
        ...
        TaskItem testItem = new TaskItem("", "blank title test", "2020-01-01");
    ...
    public void TestSetTaskItemFailsWithInvalidTitle() {
        TaskItem testItem = new TaskItem("Existing title", "will be re-assigned", "2020-01-01");
    ...
    public void TestSetTaskItemSucceedsWithValidTitle() {
        TaskItem testItem = new TaskItem("Original title", "will be re-assigned", "2020-01-01");
    ...
    public void TestCreateTaskItemFailsWithInvalidDueDate1() {
        ...
        TaskItem testItem = new TaskItem("title", "description", "date goes here");
    ...
    public void TestCreateTaskItemFailsWithInvalidDueDate3() {
        TaskItem testItem = new TaskItem("title", "description", "2020-13-01");
        assertEquals(null, testItem.getDueDate());
    }
    ...
    public void TestCreateTaskItemFailsWithInvalidDueDate4() {
        TaskItem testItem = new TaskItem("title", "description", "2020-10-33");
        assertEquals(null, testItem.getDueDate());
    }
